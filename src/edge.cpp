...
Edge::Edge(const Node *from, const Node *to, unsigned distance, double speed) : start(from),
                                                                                end(to),
                                                                                distance(distance),
                                                                                speed(speed) {}
...
BuildingEdge::BuildingEdge(unsigned from, unsigned to, unsigned distance, unsigned max_speed) : from(from),
                                                                                                to(to),
                                                                                                distance(distance),
                                                                                                max_speed(max_speed) {}
